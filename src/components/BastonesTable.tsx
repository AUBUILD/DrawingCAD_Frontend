...
interface BastonesTableProps {
  dev: any;
  appCfg: any;
  updateBaston: Function;
  bastonLenEdits: any;
  setBastonLenEdits: Function;
  normalizeBastonCfg: Function;
  snapBastonM: Function;
}
...
const BastonesTable: React.FC<BastonesTableProps> = ({
  ...
  const getCfg = (s: any, side: 'top' | 'bottom', zone: 'z1' | 'z2' | 'z3') => {
                        ...
                        {zone === 'z2' ? (
                          <>
                            <input
                              ...
                              onChange={(e) => setBastonLenEdits((p: any) => ({ ...p, [mkLenKey(i, side, zone, 'L1_m')]: e.target.value }))}
                            ...
                            <input
                              ...
                              onChange={(e) => setBastonLenEdits((p: any) => ({ ...p, [mkLenKey(i, side, zone, 'L2_m')]: e.target.value }))}
                          ...
                          <input
                            ...
                            onChange={(e) => setBastonLenEdits((p: any) => ({ ...p, [mkLenKey(i, side, zone, 'L3_m')]: e.target.value }))}
